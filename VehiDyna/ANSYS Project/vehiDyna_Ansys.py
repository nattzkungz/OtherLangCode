f = open("OtherLangCode/VehiDyna/ANSYS Project/vehiDyna_Ansys_car1.txt", "r")
...
newFile = open("OtherLangCode/VehiDyna/ANSYS Project/vehiDyna_Ansys_car1_refined.txt", "w")
for i in ffggg:
