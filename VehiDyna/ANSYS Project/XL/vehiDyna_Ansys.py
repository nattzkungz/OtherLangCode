f = open("OtherLangCode/VehiDyna/ANSYS Project/XL/XL_vehicleDynamics_ansys2.txt", "r")
...
newFile = open("OtherLangCode/VehiDyna/ANSYS Project/XL/XL_vehicleDynamics_ansys2_refined.txt", "w")
for i in ffggg:
